...
\section{Financial Strength Measures}
    ...
    \begin{itemize}
            ...
            \item 
            We present both raw and industry-adjusted metrics; the latter is defined as the difference between the firm’s measure and the industry’s median measure (Shah (1994)). \citep{Klein2009}
        \end{itemize}
