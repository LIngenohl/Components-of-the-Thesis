...
\subsection{F-Score}
    ...
    \subsection{Z-Score}
    \subsection{O-Score}
    \subsection{Book to market ratio}
...
\section{Investor-Target Ratio} 
    ...
    \begin{itemize}
        ...
        \item M&A participants are larger in size (measured in terms of sales, total assets, number of employees, and research and development (R&D) expenditure, respectively); have better technol- ogies (measured in terms of asset to labor ratio, and R&D expenditure to labor ratio, respectively); have higher productivity (defined as sales per worker); and have higher profitability (defined as total earning). For the participants, acquirers are better than targets in all these performance measures. \citep{Liu2013}

        \item M&A participants have better performance measures than non-participants prior to their M&As.
        (2) Acquirers have better performance measures than targets prior to their M&As. (3) The comparisons in (i) and (ii) also hold for post-merger performance. (4) Acquirers’ post-merger performance is better than their pre-merger performance, and targets’ post-merger performance is also better than their pre-merger performance \citep{Liu2013}
