...
\subsection{Investor Activism}
    ...
    \begin{itemize}
        ...
        \item Brav et al., 2009 - Hedge Fund Activism - A Review 
    \end{itemize}

\subsection{Abnormal Returns -- HF}
    \begin{itemize}
...
\subsection{Abnormal Returns -- Corporations}
...
\subsection{Minority Acquisitions and Partial Acquisitions}
...
\section{Financial Strength Measures}
    ...
    \begin{itemize}
            ...
            \item Important papers: \citep{DUCHIN2010}; Ljungqvist; 
        \end{itemize}
...
\subsection{Book to market ratio / Tobins Q}
    ...
    \begin{itemize}
        ...
        \item Acquisition premiums are inversely related to the target's Tobin's Q and positively related to the acquirer's Q, which suggests that targets that are undervalued aremore likely to be acquired at higher premiums; while acquirers that are overvalued tend to pay higherpremiums. \citep{Khatami2014}
...
\subsection{Leverage}
    ...
    \begin{itemize}
        ...
        \item Using book values may be justified by a recent survey by Graham and Harvey (2001) who report that managers focus on book values when setting financial structure \citep{MacKay2005}
...
\subsection{Other Measurements} 
    ...
    \begin{itemize}
        ...
        \item Profitability is earnings before interest expense and taxes (EBIT) (data item 13 minus 14) divided by total assets. \citep{MacKay2005}
...
\section{Justification for using the underlying Inputs to determine the Financial Condition}
    ...
    \begin{itemize}
        ...
        \item Information Period \citep{Choi2012} p. 6
    \end{itemize}
